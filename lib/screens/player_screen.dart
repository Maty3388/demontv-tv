      ...
      BetterPlayerConfiguration(
        ...
        eventListener: (e) {
          if (e.betterPlayerEventType == BetterPlayerEventType.play) {
            ...
            if (mounted) { Future.delayed(const Duration(milliseconds: 2500), () { if (mounted) { setState(() { _hasError = false; _isLoading = false; _isPlaying = true; }); _focusNode.requestFocus(); } }); _showControlsTemporary(); }
          }
        },
      ),
      betterPlayerDataSource: dataSource,
