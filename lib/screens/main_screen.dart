...
class _MainState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) => RawKeyboardListener(
    ...
    onKey: _onKey,
    child: WillPopScope(
      onWillPop: () async { if (_inContent && _sideIdx != 2 && _sideIdx != 5) { setState(() => _inContent = false); } else if (_inContent) { setState(() => _inContent = false); } else { _showExitDialog(); } return false; },
      child: Scaffold(
