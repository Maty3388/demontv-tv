...
class UpdateChecker {
  ...
  static Future<void> check(BuildContext context) async {
    try {
      ...
      if (context.mounted) _showDialog(context, newVersion, changelog, apkUrl, forceUpdate);
    } catch (_) {}
  }
      ...
      builder: (ctx) => WillPopScope(
        ...
        child: AlertDialog(
          ...
          content: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            const Text("Nueva version disponible", style: TextStyle(color: Color(0xFF9E9E9E), fontSize: 13)),
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
              if (!forceUpdate) TextButton(onPressed: () => Navigator.pop(ctx), child: const Text("MAS TARDE", style: TextStyle(color: Color(0xFF00CFDD), fontWeight: FontWeight.bold))),
              ElevatedButton(
                onPressed: () { Navigator.pop(ctx); _downloadAndInstall(apkUrl, ctx); },
